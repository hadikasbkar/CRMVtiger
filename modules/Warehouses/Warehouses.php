...
//    ----------------------------------------------------------------------------------
    ...
    var $sortby_fields = Array('warehousename');
    ...
    function __construct() {
        $this->log =Logger::getLogger('warehouses');
        $this->log->debug("Entering PriceBooks() method ...");
        $this->db = PearDatabase::getInstance();
        $this->column_fields = getColumnFields('Warehouse');
        $this->log->debug("Exiting Warehouse method ...");
    }
    function Warehouses() {
        self::__construct();
    }
